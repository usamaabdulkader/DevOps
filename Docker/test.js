...
//     <button onclick="window.print()" class="act" style="font-size:.7rem;gap:5px">
//       🖨&nbsp;Export / Print Report
//     </button>
//   </div>`;
// const TOOLS = [
    ...
    <div style="display:flex;flex-direction:column;gap:6px;margin-top:4px">
      ${
        lines
          ...
          .join("") ||
        '<div class="res-line" data-s="ok"><span class="res-body">Analysis incomplete —  issues found.</span></div>'
      }
    </div>
  </div>`;
}
